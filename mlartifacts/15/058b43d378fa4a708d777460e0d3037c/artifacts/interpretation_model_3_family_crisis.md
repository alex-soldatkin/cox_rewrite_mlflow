# Interpretation Report: M3: Family × Crisis 2008
...
5. **family_connection_ratio_x_crisis_2008**: Reduces hazard by **0.3%** (HR = 0.997)
6. **foreign_ownership_total_pct**: Reduces hazard by **0.1%** (HR = 0.999)
