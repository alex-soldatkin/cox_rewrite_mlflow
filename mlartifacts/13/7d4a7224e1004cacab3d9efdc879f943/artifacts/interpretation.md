...
- **family_connection_ratio_x_crisis_2004**: A one-unit increase decreases the hazard of failure by **0.8%**. (not significant)
...
- **foreign_ownership_total_pct_x_crisis_2004**: A one-unit increase decreases the hazard of failure by **0.3%**. (not significant)
...
5. **family_connection_ratio_x_crisis_2004**: Reduces hazard by **0.8%** (HR = 0.992)
6. **state_ownership_pct_x_crisis_2014**: Reduces hazard by **0.6%** (HR = 0.994)
7. **foreign_ownership_total_pct_x_crisis_2008**: Reduces hazard by **0.5%** (HR = 0.995)
8. **foreign_ownership_total_pct**: Reduces hazard by **0.4%** (HR = 0.996)
9. **state_ownership_pct**: Reduces hazard by **0.4%** (HR = 0.996)
10. **family_ownership_pct***: Reduces hazard by **0.3%** (HR = 0.997)
11. **family_connection_ratio_x_crisis_2008**: Reduces hazard by **0.3%** (HR = 0.997)
12. **state_ownership_pct_x_crisis_2008**: Reduces hazard by **0.3%** (HR = 0.997)
13. **foreign_ownership_total_pct_x_crisis_2004**: Reduces hazard by **0.3%** (HR = 0.997)
14. **state_ownership_pct_x_crisis_2004**: Reduces hazard by **0.2%** (HR = 0.998)
15. **crisis_2004**: Reduces hazard by **0.0%** (HR = 1.000)
