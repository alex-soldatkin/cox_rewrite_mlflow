...
6. **foreign_ownership_total_pct_x_crisis_2008**: Reduces hazard by **0.5%** (HR = 0.995)
7. **foreign_ownership_total_pct**: Reduces hazard by **0.4%** (HR = 0.996)
8. **state_ownership_pct**: Reduces hazard by **0.4%** (HR = 0.996)
9. **family_ownership_pct***: Reduces hazard by **0.3%** (HR = 0.997)
10. **family_connection_ratio_x_crisis_2008**: Reduces hazard by **0.3%** (HR = 0.997)
11. **state_ownership_pct_x_crisis_2008**: Reduces hazard by **0.3%** (HR = 0.997)
