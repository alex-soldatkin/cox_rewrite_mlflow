# Interpretation Report: M3: Family × Crisis
...
8. **family_connection_ratio_x_crisis_2008**: Reduces hazard by **0.3%** (HR = 0.997)
9. **foreign_ownership_total_pct**: Reduces hazard by **0.2%** (HR = 0.998)
