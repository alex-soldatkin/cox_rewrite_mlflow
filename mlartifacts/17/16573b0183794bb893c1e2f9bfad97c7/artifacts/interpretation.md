# Interpretation Report: M6: Full Interactions

## 1. Variable Interpretations
Interpretation logic: *Holding all other covariates constant...*

- **family_connection_ratio**: A one-unit increase decreases the hazard of failure by **1.0%**. (*** p<0.001)
- **family_ownership_pct**: A one-unit increase decreases the hazard of failure by **0.3%**. (* p<0.05)
...
- **governor_nabiullina**: A one-unit increase increases the hazard of failure by **0.2%**. (*** p<0.001)
...
- **family_connection_ratio_x_governor**: A one-unit increase decreases the hazard of failure by **0.6%**. (+ p<0.1)
- **family_ownership_pct_x_governor**: A one-unit increase decreases the hazard of failure by **0.1%**. (not significant)
- **state_ownership_pct_x_governor**: A one-unit increase decreases the hazard of failure by **0.4%**. (not significant)
- **foreign_ownership_total_pct_x_governor**: A one-unit increase increases the hazard of failure by **0.4%**. (not significant)
...
3. **family_connection_ratio***: Reduces hazard by **1.0%** (HR = 0.990)
4. **family_connection_ratio_x_governor**: Reduces hazard by **0.6%** (HR = 0.994)
5. **state_ownership_pct_x_governor**: Reduces hazard by **0.4%** (HR = 0.996)
6. **state_ownership_pct**: Reduces hazard by **0.4%** (HR = 0.996)
7. **family_ownership_pct***: Reduces hazard by **0.3%** (HR = 0.997)
8. **foreign_ownership_total_pct**: Reduces hazard by **0.2%** (HR = 0.998)
9. **family_ownership_pct_x_governor**: Reduces hazard by **0.1%** (HR = 0.999)
...
3. **foreign_ownership_total_pct_x_governor**: Increases hazard by **0.4%** (HR = 1.004)
4. **rw_page_rank_4q_lag**: Increases hazard by **0.4%** (HR = 1.004)
5. **governor_nabiullina***: Increases hazard by **0.2%** (HR = 1.002)
6. **crisis_2008**: Increases hazard by **0.1%** (HR = 1.001)
7. **crisis_2014**: Increases hazard by **0.1%** (HR = 1.001)
