# Interpretation Report: M5: Foreign × Governor
...
- **family_ownership_pct**: A one-unit increase decreases the hazard of failure by **0.4%**. (** p<0.01)
...
- **governor_nabiullina**: A one-unit increase increases the hazard of failure by **0.2%**. (** p<0.01)
...
- **foreign_ownership_total_pct_x_governor**: A one-unit increase increases the hazard of failure by **0.5%**. (not significant)
...
7. **crisis_2004**: Reduces hazard by **0.0%** (HR = 1.000)
...
3. **foreign_ownership_total_pct_x_governor**: Increases hazard by **0.5%** (HR = 1.005)
