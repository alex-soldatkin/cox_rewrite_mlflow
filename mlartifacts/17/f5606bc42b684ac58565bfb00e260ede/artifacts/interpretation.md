# Interpretation Report: M3: Family × Governor
...
7. **foreign_ownership_total_pct**: Reduces hazard by **0.2%** (HR = 0.998)
8. **family_ownership_pct_x_governor**: Reduces hazard by **0.1%** (HR = 0.999)
9. **crisis_2004**: Reduces hazard by **0.0%** (HR = 1.000)
...
4. **governor_nabiullina***: Increases hazard by **0.2%** (HR = 1.002)
5. **crisis_2008**: Increases hazard by **0.1%** (HR = 1.001)
6. **crisis_2014**: Increases hazard by **0.1%** (HR = 1.001)
