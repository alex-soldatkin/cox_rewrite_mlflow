# Interpretation Report: M4_pseudo_crisis
...
- **pseudo_2008**: A one-unit increase increases the hazard of failure by **0.1%**. (not significant)
- **pseudo_2014**: A one-unit increase decreases the hazard of failure by **0.2%**. (* p<0.05)
- **family_connection_ratio_x_pseudo_2008**: A one-unit increase decreases the hazard of failure by **0.5%**. (not significant)
- **family_connection_ratio_x_pseudo_2014**: A one-unit increase decreases the hazard of failure by **1.1%**. (+ p<0.1)
...
4. **family_connection_ratio_x_pseudo_2014**: Reduces hazard by **1.1%** (HR = 0.989)
5. **family_connection_ratio_x_pseudo_2008**: Reduces hazard by **0.5%** (HR = 0.995)
6. **state_ownership_pct**: Reduces hazard by **0.5%** (HR = 0.995)
7. **family_ownership_pct***: Reduces hazard by **0.3%** (HR = 0.997)
8. **foreign_ownership_total_pct**: Reduces hazard by **0.2%** (HR = 0.998)
9. **pseudo_2014***: Reduces hazard by **0.2%** (HR = 0.998)
...
4. **pseudo_2008**: Increases hazard by **0.1%** (HR = 1.001)
