# Interpretation Report: M8_random

## 1. Variable Interpretations
Interpretation logic: *Holding all other covariates constant...*

- **random_ownership**: A one-unit increase increases the hazard of failure by **0.0%**. (not significant)
...
4. **random_ownership**: Increases hazard by **0.0%** (HR = 1.000)
