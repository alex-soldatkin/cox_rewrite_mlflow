# Interpretation Report: Model 1: Baseline (No Community Control)
...
- **camel_tier1_capital_ratio**: A one-unit increase increases the hazard of failure by **1.8%**. (*** p<0.001)
- **foreign_FEC_d**: A one-unit increase decreases the hazard of failure by **10.8%**. (*** p<0.001)
...
2. **foreign_FEC_d***: Reduces hazard by **10.8%** (HR = 0.892)
3. **camel_roa***: Reduces hazard by **9.6%** (HR = 0.904)
4. **family_rho_F***: Reduces hazard by **3.0%** (HR = 0.970)
5. **network_page_rank**: Reduces hazard by **1.3%** (HR = 0.987)
...
1. **camel_tier1_capital_ratio***: Increases hazard by **1.8%** (HR = 1.018)
