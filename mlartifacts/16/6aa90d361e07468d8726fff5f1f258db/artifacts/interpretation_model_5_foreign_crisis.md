# Interpretation Report: M5: Foreign × Crisis 2014
...
- **crisis_2014**: A one-unit increase decreases the hazard of failure by **2.1%**. (not significant)
...
3. **crisis_2014**: Reduces hazard by **2.1%** (HR = 0.979)
4. **family_connection_ratio***: Reduces hazard by **1.1%** (HR = 0.989)
5. **foreign_ownership_total_pct**: Reduces hazard by **0.7%** (HR = 0.993)
