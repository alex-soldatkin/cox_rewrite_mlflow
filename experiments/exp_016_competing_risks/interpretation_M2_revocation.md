# Interpretation Report: M2: Forced revocation only
...
4. **foreign_ownership_total_pct**: Reduces hazard by **0.6%** (HR = 0.994)
5. **state_ownership_pct**: Reduces hazard by **0.3%** (HR = 0.997)
