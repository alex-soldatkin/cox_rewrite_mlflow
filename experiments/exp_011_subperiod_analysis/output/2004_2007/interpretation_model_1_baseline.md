# Interpretation Report: M1: Baseline (2004-2007)
...
1. **family_connection_ratio***: Reduces hazard by **1.8%** (HR = 0.982)
2. **state_ownership_pct***: Reduces hazard by **1.0%** (HR = 0.990)
3. **family_ownership_pct***: Reduces hazard by **0.6%** (HR = 0.994)
4. **foreign_ownership_total_pct**: Reduces hazard by **0.2%** (HR = 0.998)
