# Interpretation Report: M2: Crisis 2008 Indicator
...
- **crisis_2008**: A one-unit increase increases the hazard of failure by **3.0%**. (not significant)
...
1. **crisis_2008**: Increases hazard by **3.0%** (HR = 1.030)
